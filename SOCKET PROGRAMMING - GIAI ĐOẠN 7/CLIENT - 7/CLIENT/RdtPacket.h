...
// Giai đoạn 7: Go-Back-N (Sliding Window) + Congestion Control (AIMD) trên nền UDP
// (Nâng cấp từ Stop-and-Wait cũ: seqNum giờ tăng dần liên tục 0,1,2,... thay vì chỉ toggle 0/1;
//  ACK mang tính "cumulative" - xác nhận đã nhận LIÊN TỤC tới đâu, không còn ACK từng gói lẻ)
// ============================================================
