...
string CommandHandler::handleHelp(const string& arg) {
    ...
    case FtpCommand::HASH: return "214 Syntax: HASH <filename> - Compute SHA-256 hash of the specified file\r\n";
...
string CommandHandler::handleHash(Session& s, const string& arg) {
    ...
    string hashVal = computeFileSHA256(target.string());
    if (hashVal.empty()) return format("550 Cannot compute hash for {}\r\n", arg);
