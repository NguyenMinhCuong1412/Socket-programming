...
// ----- Go-Back-N Sliding Window (Giai đoạn 7) -----
constexpr int GBN_MAX_WINDOW       = 32;    // Kích thước cửa sổ tối đa (số gói gửi cùng lúc)
constexpr int GBN_INITIAL_SSTHRESH = 16;    // Ngưỡng slow-start ban đầu (chuyển sang congestion avoidance)
...
// ============================================================
struct RdtPacket {
    uint32_t seqNum;        // Sequence number (tăng dần: 0, 1, 2, ... cho Go-Back-N)
